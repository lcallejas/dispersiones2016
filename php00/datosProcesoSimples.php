	...
	if($_SESSION){
		...
		//if($permisos != 4){
			...
			if($accion == 'alta'){
				...
				$datos[2]="'1'";
	    		$datos[3]=$totalNominas;
	    		$datos[4]="''";
	    		$datos[5]="''";
	    		$datos[6]=1;
	    		if(isset($_POST['empEnt'])){
	    			$datos[7]=0;
	    		}else{
	    			$datos[7]=1;
	    		}
				...
				//Comienza alta en tabla movimientoSimple.
				if(isset($_POST['empEnt'])){
					$columna3[0] = "id";
					$columna3[1] = "idMov";
					$columna3[2] = "origen";
				...
				if(isset($_POST['paraDest'])){
					...
					$datos2[1]=extrae_ultimo_id('movimiento');
					    $paraDestino = $_POST['paraDest'];
						$tipoTransDestino = $_POST['tipoTransDest'];
						$montoDestino = $_POST['montoDest'];
						$bancoDestino = $_POST['bancoDest'];
						$cuentaDestino = $_POST['cuentaDest'];
						$comentarioDestino = $_POST['comentarioDest'];
					$datos2[7]=0;
					$datos2[8]=3;
					$datos2[9]="''";
				...
				header("Location: ../movimientos/nuevoProcesoSimple.php");
			}else if($accion == 'baja'){
				$dato = $_POST['listado'];
