            ...
            function myCreateFunctionFinal() {
                var table = document.getElementById("myTableFinal"); {
                    ...
                    var dispersoraDestino = document.formulario.dispersoraFinal.value;
                    ...
                    if(paraDestino == ""){
                        ...
                        cell8.innerHTML = '<td class="botnMov"><input type="hidden" name="pdfAnt[]" value=""><input type="file" name="pdf[]">';
                        ...
                        document.getElementById("dispersoraFinal").value = "";
