            function myCreateFunction() {
            	var table = document.getElementById("myTable"); {
                    ...
                    if(origenSalida == "Seleccion"){
                        ...
                        document.getElementById("limiteSalida").value = "";
            ...
            function cambiaValorCheckEntrada() {
                var chkbox=document.getElementById("checkEntrada");
                if(null!=chkbox&&true==chkbox.checked){
                    document.getElementById("checkEnt").value = 1;
                }else{
                    document.getElementById("checkEnt").value = 0;
                }
            }
