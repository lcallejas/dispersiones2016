...
-->                        
                        <select name="permisos" id="permisos">
                            <option>Seleccion</option>
                            <option value="1" <?php if($tipo=="Administrador") echo "selected='Administrador'"; ?>>Administrador</option>
                            <option value="2" <?php if($tipo=="Director") echo "selected='Director'"; ?>>Director</option>
                            <option value="3" <?php if($tipo=="Gerente") echo "selected='Gerente'"; ?>>Gerente</option>
                            <option value="4" <?php if($tipo=="Dispersora") echo "selected='Dispersora'"; ?>>Dispersora</option>
                            <option value="5" <?php if($tipo=="Capturista") echo "selected='Capturista'"; ?>>Capturista</option>
                            <option value="6" <?php if($tipo=="Aux. Dirección") echo "selected='Aux. Dirección'"; ?>>Aux. Dirección</option>
                        </select>
