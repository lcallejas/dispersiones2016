...
<html>
    <head>
        ...
        <script type="text/javascript" src="../js/agregarFilaTabla7.js"></script>
        <script type="text/javascript" src="../js/limites.js"></script>
        <script type="text/javascript" src="../js/ajax.js"></script>
    </head>
    <body onload="setTotalNominas();setTotal();setTotalFinal();">
        <div id="principal">
            <div id="cabecera">
            ...
            <div id="contenido">
                <form method="POST" name="formulario" id="formulario" enctype="multipart/form-data">
                    <div id="entrada">
                        <div class="izquierda">
                            <?php
                                echo "<h1>Modificar Movimiento Directo: ";
                        ...
                        <table id="myTableNominas" name="myTableNominas" border="1">
                            ...
                            <?php
                                tabla_mov_incompletos_directo_modific($valor);
                            ?>
                        </table>
                        ...
                        <div id="salidas">
                            ...
                            <div class="izquierda">
                                <h2>Dispersora:</h2>
                                <input type="text" name="dispersoraFinal" id="dispersoraFinal" placeholder="Dispersora" maxlength="50" onKeyUp="soloMayusculas(this.value,this.id)">
                            </div>
                            <div class="izquierda">
                                <h3>Banco/Cuenta<br>Receptor:</h3>
                                <input type="text" name="bancoFinal" id="bancoFinal" placeholder="Banco/Cuenta Receptor" maxlength="50" onKeyUp="soloMayusculas(this.value,this.id)">
                            </div>
                            <div class="izquierda">
                                <h3>Banco/Cuenta<br>Destino:</h3>
                                <input type="text" name="cuentaFinal" id="cuentaFinal" placeholder="Banco/Cuenta Destino" maxlength="50" onKeyUp="soloMayusculas(this.value,this.id)">
                            </div>
                            <div class="izquierda">
                                <h2>Comentario:</h2>
                        ...
                        <table id="myTableFinal" name="myTableFinal" border="1">
                            <tr>
                                ...
                                <td><strong>Monto</strong></td>
                                <td><strong>Dispersora</strong></td>
                                ...
                                <td><strong>Eliminar</strong></td>
                            <?php
                                tabla_mov_incompletos_nomina_modific_finales($valor);
                            ?>
                            </tr>
                        </table>
                        ...
                        <input type="button" name="registrarButton" value="Registrar Movimiento"  onClick="validar('ModificarDirectoCompleto')">
