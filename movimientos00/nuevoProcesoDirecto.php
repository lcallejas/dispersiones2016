	    	...
	    	<div id="contenido">
                <form method="POST" name="formulario" id="formulario">
                    <div id="entrada">
                        ...
                        <br><br>
                            <div>
                                <button onclick="myCreateFunctionDirecto()" type="button">Agregar</button>
                                <button onclick="myDeleteFunctionDirecto()" type="button">Eliminar</button>
                            </div>
                        </div>
                        <br><br><br><br>
                        ...
                        <div id="salidas">
                            ...
                            <div class="izquierda">
                                <h2>Dispersora:</h2>
                                <input type="text" name="dispersoraDestino" id="dispersoraDestino" placeholder="Dispersora" maxlength="50" onKeyUp="soloMayusculas(this.value,this.id)">
                            </div>
                            <div class="izquierda">
                                <h3>Banco/Cuenta<br>Receptor:</h3>
                                <input type="text" name="bancoDestino" id="bancoDestino" placeholder="Banco/Cuenta Receptor" maxlength="50" onKeyUp="soloMayusculas(this.value,this.id)">
                            </div>
                            <div class="izquierda">
                                <h3>Banco/Cuenta<br>Destino:</h3>
                                <input type="text" name="cuentaDestino" id="cuentaDestino" placeholder="Banco/Cuenta Destino" maxlength="50" onKeyUp="soloMayusculas(this.value,this.id)">
                            </div>
                            <div class="izquierda">
                                <h2>Comentario:</h2>
                        ...
                        <input type="button" value="Registrar Movimiento"  onClick="validar('NuevoProcesoDirecto')">
                    </div>
                </form>
            </div>
	        <div id="pie">
