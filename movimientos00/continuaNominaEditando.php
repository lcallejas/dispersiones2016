            ...
            <div id="contenido">
                <form method="POST" name="formulario" id="formulario">
                    <div id="entrada">
                        <div class="izquierda">
                            <?php
                                echo "<h1>Continuar Movimiento de Nómina: ";
                        ...
                        <input type="button" name="registrarButton" value="Registrar Movimiento"  onClick="validarNominas()">
