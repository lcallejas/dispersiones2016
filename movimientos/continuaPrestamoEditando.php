<?php
    ...
    if($_SESSION){
        ...
        $Consulta = "SELECT a.fecha, a.hora, a.origen, a.empresa, a.monto, a.banco, a.cuenta, a.realizado, b.comentario FROM movimiento a, movimientoprestamo b WHERE a.id = $valor AND b.idMov = $valor";
                    ...
                    <div id="entrada">
                        ...
                        <table id="myTable" name="myTable" border="1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                        echo "<label name='comentarioDestino' id='comentarioDestino' >";
                                            echo $row[8];
                                        echo"</label>";
                                    ?>
                                </td>
