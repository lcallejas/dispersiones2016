<?php
    ...
    if($_SESSION){
        ...
        $Consulta = "SELECT fecha, hora, origen, monto FROM movimiento WHERE id = $valor";
            ...
            <div id="contenido">
                <form method="POST" name="formulario" id="formulario">
                    <div id="entrada">
                        <div class="izquierda">
                            <?php
                                echo "<h1>Continuar Movimiento Símple: ";
                        ...
                        <input type="button" name="registrarButton" value="Registrar Movimiento"  onClick="validarSimple()">
